            ...
            <Toolbar component={Box} px={3} variant={'dense'} className={classes.marginToolbar} py={1}>
                ...
                <Hidden smDown>
                    <Box display={'flex'} width={'45%'} justifyContent={'space-around'}>
                        <Typography component={Link} href={'/'} as={'/'} style={{textDecoration: 'none', color: '#F03D5F'}}>
                            {'Home'}
                        </Typography>
                        <Typography component={Link} href={'/about'} as={'/about'} style={{textDecoration: 'none', color: '#F03D5F'}}>
                            {'About'}
                        </Typography>
                        <Typography component={Link} href={'/request'} as={'/request'} style={{textDecoration: 'none', color: '#F03D5F'}}>
                            {'Request'}
                        </Typography>
                        <Typography component={Link} href={'/contact'} as={'/contact'} style={{textDecoration: 'none', color: '#F03D5F'}}>
                            {'Contact'}
                        </Typography>
                        <Typography component={Link} href={'/login'} as={'/login'} style={{textDecoration: 'none', color: '#F03D5F'}}>
                            {'Login'}
                        </Typography>
                    </Box>
                </Hidden>
                            ...
                            >
                                <div style={{width: '100%', height: '20px', display: 'flex',justifyContent: 'flex-end', alignItems: 'center'}}>
                                    <Button style={{ minWidth: '0', margin: '10px 10px 0 0'}}>
                                        <CloseIcon onClick={() => setOpen(false)} style={{height: '8em', width: '1.5em'}} />
                                    </Button>
                                </div>
