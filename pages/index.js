        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        <Box width={{xs: '100%', sm: '50%'}} data-aos="fade-right" data-aos-delay="300">
                            <Box my={{xs: 3, md: 0}}>
                                <Hidden smDown>
                                    <Typography style={{fontSize: '60px', fontWeight: '900', color: '#3F3D56'}}
                                                variant={'h2'}>
                                        {'BUILD YOUR'}
                                        <br/>
                                        {'CAREER WITH US'}
                                ...
                                <Hidden mdUp>
                                    <Typography style={{fontSize: '40px', fontWeight: '900', color: '#3F3D56'}}
                                                variant={'h2'}>
                                        {'BUILD YOUR'}
                                        <br/>
                                        {'CAREER WITH US'}
                            ...
                            <Box>
                                <Typography style={{color: '#515151', fontWeight: 200, marginTop: '10px'}}
                                            variant={"subtitle2"}>
                        ...
                        <Hidden smDown>
                            <Box width={{xs: '100%', sm: '50%'}} data-aos="fade-left" data-aos-delay="300">
